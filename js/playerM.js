...
// videoControlls.addEventListener('touchstart',() => {
//   clearTimeout(viewUI)
//   viewUICheck = true
// })
// videoControlls.addEventListener('touchend', () => {
//   viewUICheck = false
// })
function hideViewUI() {
setTimeout(() => {
    if(mainVideoContainer.classList.contains('view-UI') === false ) {
      clearTimeout(viewUI)
      UIValue = true
    ...
    } else if (mainVideoContainer.classList.contains('view-UI') && viewUICheck === false) {
      clearTimeout(viewUI)
      UIValue = false
      mainVideoContainer.classList.remove('view-UI')
    }
